...
def parse_args() -> argparse.Namespace:
    ...
    # Get DOCUMENT_PROCESSING_BATCH_SIZE from environment
    args.document_processing_batch_size = get_env_value("DOCUMENT_PROCESSING_BATCH_SIZE", DEFAULT_DOCUMENT_PROCESSING_BATCH_SIZE, int)
