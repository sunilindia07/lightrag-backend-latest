...
-- 1) Create database (use your POSTGRES_DATABASE value from .env)
CREATE DATABASE airag;  -- Change 'airag' to your database name, should match environment variable

-- 2) Connect to the new database
\c airag  -- Change 'airag' to your database name, should match environment variable
...
# As your normal user (use values from your .env file)
# Replace with your actual values: POSTGRES_HOST, POSTGRES_PORT, POSTGRES_USER, POSTGRES_DATABASE
psql -h localhost -p 5433 -U postgres -d airag

# ============================================
# IMPORTANT: Environment Variables
# ============================================
# After setup, configure your .env file with these values:
